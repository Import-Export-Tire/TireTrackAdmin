    ...
    <SelectPrimitive.Portal>
      ...
      >
        <SelectPrimitive.Popup
          ...
          className={cn("relative z-50 max-h-96 min-w-[8rem] overflow-hidden rounded-xl border border-ios-gray5 bg-white shadow-ios-lg data-[state=open]:animate-in data-[state=closed]:animate-out", className )}
          {...props}
        >
