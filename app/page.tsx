...
function Dashboard() {
  ...
  const filteredTrucks = useMemo(() => {
    const filtered = trucks?.filter((truck) => {
      ...
      // Search by truck number or vendor locally, tracking uses server-side results
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4">
          ...
          <div className="flex items-center justify-between mb-3 lg:mb-0">
            <div className="flex items-center gap-3 sm:gap-4">
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-ios-blue rounded-2xl flex items-center justify-center shadow-ios">
                <svg className="w-6 h-6 sm:w-7 sm:h-7 text-[#1c1c1e]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
                </svg>
              </div>
              <div>
                <h1 className="text-lg sm:text-2xl font-bold tracking-tight text-[#1c1c1e]">
                  TireTrack Admin
                </h1>
                <p className="text-xs sm:text-sm text-ios-gray1 hidden sm:block">Warehouse Management Dashboard</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              <div className="text-right hidden sm:block">
                <p className="text-sm font-medium text-[#1c1c1e]">{admin?.name}</p>
                <p className="text-xs text-ios-gray1 capitalize">{admin?.role}</p>
              </div>
              <button
                onClick={logout}
              ...
              <button
                ...
                className={`px-3 sm:px-4 py-2 rounded-lg text-xs sm:text-sm font-medium transition-all whitespace-nowrap ${
                  !showUsers && !showAdmins && !showErrorLogs
                    ...
                    : "text-ios-gray1 hover:text-[#1c1c1e] hover:bg-white/60"
                }`}
              >
                Manifests
              </button>
            ...
            <div className="flex items-center gap-2 sm:gap-3 sm:ml-auto">
              <div className="relative">
                <select
                  ...
                  className="flex-1 sm:flex-none pl-3 pr-8 py-2 sm:py-2.5 bg-white border border-ios-gray5 rounded-xl text-sm focus:outline-none focus:border-ios-blue focus:ring-2 focus:ring-ios-blue/20 transition-all appearance-none cursor-pointer hover:border-ios-gray4"
                >
                  {availableLocations.map((loc) => (
                    <option key={loc.id} value={loc.id}>{loc.name}</option>
                  ))}
                </select>
                <svg className="w-4 h-4 text-ios-gray1 absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                </svg>
              </div>

              <div className="relative flex-1 sm:flex-none">
                <svg className="w-4 h-4 sm:w-5 sm:h-5 text-ios-gray1 absolute left-3 top-1/2 -translate-y-1/2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <input
                  ...
                  className="w-full sm:w-56 pl-9 sm:pl-10 pr-3 sm:pr-4 py-2 sm:py-2.5 bg-white border border-ios-gray5 rounded-xl text-sm focus:outline-none focus:border-ios-blue focus:ring-2 focus:ring-ios-blue/20 transition-all"
                />
              </div>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto p-4 sm:p-6">
          ...
          <div className="bg-white backdrop-blur border border-ios-gray5 rounded-xl sm:rounded-2xl p-4 sm:p-5 hover:border-ios-gray4 transition-all group">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl sm:text-3xl font-bold mt-1 text-[#1c1c1e]">{trucksToday}</p>
              </div>
              <div className="w-11 h-11 sm:w-14 sm:h-14 bg-ios-gray5 group-hover:bg-ios-gray5 rounded-xl sm:rounded-2xl flex items-center justify-center transition-colors">
                <svg className="w-6 h-6 sm:w-7 sm:h-7 text-ios-gray1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="bg-white backdrop-blur border border-ios-gray5 rounded-xl sm:rounded-2xl p-4 sm:p-5 hover:border-ios-gray4 transition-all group">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl sm:text-3xl font-bold mt-1 text-[#1c1c1e]">{closedToday}</p>
              </div>
              <div className="w-11 h-11 sm:w-14 sm:h-14 bg-ios-gray5 group-hover:bg-ios-gray5 rounded-xl sm:rounded-2xl flex items-center justify-center transition-colors">
                <svg className="w-6 h-6 sm:w-7 sm:h-7 text-ios-gray1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="bg-white backdrop-blur border border-ios-gray5 rounded-xl sm:rounded-2xl p-4 sm:p-5 hover:ring-ios-blue/20 transition-all group">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl sm:text-3xl font-bold mt-1 text-ios-blue">{(scansToday ?? 0).toLocaleString()}</p>
              </div>
              <div className="w-11 h-11 sm:w-14 sm:h-14 ring-ios-blue/20 group-hover:ring-ios-blue/20 rounded-xl sm:rounded-2xl flex items-center justify-center transition-colors">
                <svg className="w-6 h-6 sm:w-7 sm:h-7 text-ios-blue" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {showAdmins ? (
          ...
          <div className="bg-white backdrop-blur border border-ios-gray5 rounded-2xl overflow-hidden shadow-xl">
            <div className="p-5 sm:p-6 border-b border-ios-gray5">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 className="text-lg sm:text-xl font-semibold text-[#1c1c1e]">Admin Users</h2>
                    <p className="text-ios-gray1 text-xs sm:text-sm">Manage dashboard access</p>
                  </div>
                </div>
                <button
            ...
            {admins === undefined ? (
              <div className="flex items-center justify-center py-16">
                <div className="w-10 h-10 border-2 border-ios-blue border-t-transparent rounded-full animate-spin"></div>
              </div>
            ) : (
                ...
                <table className="w-full">
                  <thead>
                    <tr className="bg-white/80 border-b border-ios-gray5">
                      <th className="px-5 py-4 text-left text-xs font-semibold text-ios-gray1 uppercase tracking-wider">Name</th>
                      <th className="px-5 py-4 text-left text-xs font-semibold text-ios-gray1 uppercase tracking-wider hidden sm:table-cell">Email</th>
                      <th className="px-5 py-4 text-left text-xs font-semibold text-ios-gray1 uppercase tracking-wider">Role</th>
                      <th className="px-5 py-4 text-left text-xs font-semibold text-ios-gray1 uppercase tracking-wider hidden md:table-cell">Locations</th>
                      <th className="px-5 py-4 text-left text-xs font-semibold text-ios-gray1 uppercase tracking-wider">Status</th>
                      <th className="px-5 py-4 text-left text-xs font-semibold text-ios-gray1 uppercase tracking-wider hidden lg:table-cell">Last Login</th>
                  ...
                  <tbody className="divide-y divide-ios-gray5">
                    {admins.map((a) => (
                      <tr key={a.id} className="hover:bg-white transition-colors">
                        <td className="px-5 py-4 font-medium text-[#1c1c1e]">{a.name}</td>
                        <td className="px-5 py-4 text-ios-gray1 hidden sm:table-cell">{a.email}</td>
                        ...
                        <td className="px-5 py-4 text-ios-gray1 text-sm hidden md:table-cell">
                        ...
                        <td className="px-5 py-4 text-ios-gray1 text-sm hidden lg:table-cell">
                        ...
                        <td className="px-5 py-4">
                          <div className="flex items-center justify-end gap-1">
                            <button
                              ...
                              className="p-2 hover:bg-ios-gray5 rounded-lg transition-colors"
                              title="Edit"
                            >
                            ...
                            >
                              {a.isActive ? (
                                <svg className="w-4 h-4 text-ios-orange" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="bg-white backdrop-blur border border-ios-gray5 rounded-2xl overflow-hidden shadow-xl">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-ios-gray1 text-xs sm:text-sm">{errorLogs?.length || 0} recent errors</p>
                  </div>
                </div>
            ...
            {!errorLogs ? (
              <div className="p-8 text-center text-ios-gray1">Loading error logs...</div>
            ) : errorLogs.length === 0 ? (
              <div className="p-8 text-center text-ios-gray1">No error logs found. System is running clean.</div>
            ) : (
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead>
                    <tr className="border-b border-ios-gray5">
                      <th className="text-left p-3 sm:p-4 text-xs font-medium text-ios-gray1 uppercase tracking-wider">Time</th>
                      <th className="text-left p-3 sm:p-4 text-xs font-medium text-ios-gray1 uppercase tracking-wider">Who / Where</th>
                      <th className="text-left p-3 sm:p-4 text-xs font-medium text-ios-gray1 uppercase tracking-wider">Type</th>
                      <th className="text-left p-3 sm:p-4 text-xs font-medium text-ios-gray1 uppercase tracking-wider">Message</th>
                      <th className="text-left p-3 sm:p-4 text-xs font-medium text-ios-gray1 uppercase tracking-wider">Status</th>
                    </tr>
                  </thead>
                  <tbody>
                    {errorLogs.map((error: any) => (
                      <Fragment key={error._id}>
                        <tr className={`border-b border-ios-gray5 hover:bg-ios-gray6 transition-colors cursor-pointer ${!error.resolved ? "bg-ios-red/10" : ""}`}
                          onClick={() => {
                            const el = document.getElementById(`error-detail-${error._id}`);
                            if (el) el.classList.toggle("hidden");
                          }}
                        >
                          <td className="p-3 sm:p-4 text-xs sm:text-sm text-[#1c1c1e] whitespace-nowrap">
                          ...
                          <td className="p-3 sm:p-4">
                            {error.resolved ? (
                              <span className="text-xs text-ios-green font-medium">Resolved</span>
                            ) : canEdit ? (
                              <button
                              ...
                              <span className="text-xs text-ios-red font-medium">Unresolved</span>
                            )}
                          </td>
                        </tr>
                        <tr id={`error-detail-${error._id}`} className="hidden">
                          <td colSpan={5} className="p-3 sm:p-4 bg-white border-b border-ios-gray5">
                            <div className="flex flex-col gap-2 text-xs">
                              {error.rawBarcode && (
                                <div>
                                  <span className="text-ios-gray1 font-medium">Raw Barcode: </span>
                                  <code className="text-ios-orange bg-white/80 px-2 py-1 rounded font-mono break-all">{error.rawBarcode}</code>
                                </div>
                              )}
                              {error.trackingNumber && (
                                <div>
                                  <span className="text-ios-gray1 font-medium">Tracking: </span>
                                  <code className="text-ios-blue font-mono">{error.trackingNumber}</code>
                                </div>
                              )}
                              {error.details && (
                                <div>
                                  <span className="text-ios-gray1 font-medium">Full Details: </span>
                                  <code className="text-ios-gray1 font-mono text-[10px] break-all">{error.details}</code>
                                </div>
                              )}
                            </div>
                          </td>
            ...
            <div className="p-5 sm:p-6 border-b border-ios-gray5">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 className="text-lg sm:text-xl font-semibold text-[#1c1c1e]">App Users</h2>
                    <p className="text-ios-gray1 text-xs sm:text-sm">{filteredUsers?.length || 0} warehouse users</p>
                  </div>
                </div>
                {canEdit && (
                  <button
              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead>
                    <tr className="bg-white/80 border-b border-ios-gray5">
                      <th className="px-5 py-4 text-left text-xs font-semibold text-ios-gray1 uppercase tracking-wider">Name</th>
                      <th className="px-5 py-4 text-left text-xs font-semibold text-ios-gray1 uppercase tracking-wider hidden sm:table-cell">Employee ID</th>
                      <th className="px-5 py-4 text-left text-xs font-semibold text-ios-gray1 uppercase tracking-wider">Location</th>
                      <th className="px-5 py-4 text-right text-xs font-semibold text-ios-gray1 uppercase tracking-wider hidden md:table-cell">This Month</th>
                      <th className="px-5 py-4 text-right text-xs font-semibold text-ios-gray1 uppercase tracking-wider hidden md:table-cell">All Time</th>
                      <th className="px-5 py-4 text-right text-xs font-semibold text-ios-gray1 uppercase tracking-wider hidden lg:table-cell">Accuracy</th>
                      <th className="px-5 py-4 text-left text-xs font-semibold text-ios-gray1 uppercase tracking-wider">Status</th>
                      {canEdit && <th className="px-5 py-4 text-right text-xs font-semibold text-ios-gray1 uppercase tracking-wider">Actions</th>}
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-ios-gray5">
                    {filteredUsers?.map((user) => {
                      ...
                      const accuracyColor = accuracy >= 99 ? "text-ios-green" : accuracy >= 98 ? "text-ios-orange" : "text-ios-red";
                      return (
                      <tr key={user._id} className="hover:bg-white transition-colors">
                        ...
                        <td className="px-5 py-4 text-[#1c1c1e]">{user.locationName || "-"}</td>
                        <td className="px-5 py-4 text-right hidden md:table-cell">
                          {userStats ? (
                            <div>
                              <span className="font-semibold text-[#1c1c1e]">{userStats.monthlyScans?.toLocaleString() || 0}</span>
                              {userStats.monthlyBadScans > 0 && (
                                <span className="text-ios-red text-xs ml-1">({userStats.monthlyBadScans} bad)</span>
                              )}
                            </div>
                          ) : (
                        ...
                        <td className="px-5 py-4 text-right hidden md:table-cell">
                          {userStats ? (
                            <div>
                              <span className="text-[#1c1c1e]">{userStats.totalScans?.toLocaleString() || 0}</span>
                              {userStats.badScans > 0 && (
                                <span className="text-ios-red text-xs ml-1">({userStats.badScans} bad)</span>
                              )}
                            </div>
                          ) : (
                            <span className="text-ios-gray2">-</span>
                          ...
                          <td className="px-5 py-4">
                            <div className="flex items-center justify-end gap-1">
                              <button
                                ...
                                title="Edit"
                              >
                                <svg className="w-4 h-4 text-ios-gray1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="bg-white backdrop-blur border border-ios-gray5 rounded-2xl overflow-hidden shadow-xl">
              <div className="p-5 border-b border-ios-gray5">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-3">
                    <div className="w-9 h-9 bg-ios-gray5 rounded-lg flex items-center justify-center">
                      <svg className="w-5 h-5 text-ios-gray1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4" />
                      </svg>
                    </div>
                    <h2 className="text-lg font-semibold text-[#1c1c1e]">Trucks</h2>
                  </div>
                </div>
              ...
              {trucks === undefined ? (
                ...
                <div className="p-3 space-y-2 max-h-[600px] overflow-y-auto">
                  {filteredTrucks?.length === 0 ? (
                    <div className="flex flex-col items-center justify-center py-12 text-ios-gray1">
                      <svg className="w-12 h-12 mb-3 text-[#1c1c1e]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4" />
                      </svg>
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <div className="text-sm text-[#1c1c1e] mt-0.5 flex items-center gap-2 flex-wrap">
                                <span className="text-ios-gray1">{truck.carrier}</span>
                                <span className="text-ios-gray2">|</span>
                                <span className="font-medium">{truck.scanCount || 0} scans</span>
                              </div>
                              <div className="text-xs text-ios-gray1 mt-1 flex items-center gap-2 flex-wrap">
                                <span>{getLocationName(truck.locationId)}</span>
                                <span className="text-ios-gray2">|</span>
                                <span className="text-ios-blue/70">Opened: {truck.openedByName || "Unknown"}</span>
                                {truck.closedByName && (
                                  <>
                                    <span className="text-ios-gray2">|</span>
                                    <span className="text-ios-orange/70">Closed: {truck.closedByName}</span>
                                  </>
                                )}
                              </div>
                            </div>
            ...
            <div className="lg:col-span-2 bg-white backdrop-blur border border-ios-gray5 rounded-2xl overflow-hidden shadow-xl">
              <div className="p-5 border-b border-ios-gray5">
                <div className="flex flex-wrap items-center justify-between gap-3">
                  <div className="flex items-center gap-3">
                    <div className="w-9 h-9 ring-ios-blue/20 rounded-lg flex items-center justify-center">
                      <svg className="w-5 h-5 text-ios-blue" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 4v1m6 11h2m-6 0h-2v4m0-11v3m0 0h.01M12 12h4.01M16 20h4M4 12h4m12 0h.01M5 8h2a1 1 0 001-1V5a1 1 0 00-1-1H5a1 1 0 00-1 1v2a1 1 0 001 1zm12 0h2a1 1 0 001-1V5a1 1 0 00-1-1h-2a1 1 0 00-1 1v2a1 1 0 001 1zM5 20h2a1 1 0 001-1v-2a1 1 0 00-1-1H5a1 1 0 00-1 1v2a1 1 0 001 1z" />
                      </svg>
                    </div>
                    <div>
                      <h2 className="text-lg font-semibold text-[#1c1c1e]">Scans</h2>
                      {selectedTruck && <p className="text-ios-blue text-sm">{filteredScans?.length || 0} records</p>}
                    </div>
                  </div>
                          ...
                          <div className="absolute right-0 mt-2 w-56 bg-white border border-ios-gray5 rounded-xl shadow-2xl z-30 overflow-hidden">
                            <div className="p-2">
                              <button onClick={() => { downloadAllManifest(); setVendorExportTruck(null); }} className="w-full text-left px-3 py-2.5 hover:bg-ios-gray5 rounded-lg text-sm transition-colors flex items-center justify-between">
                                ...
                                <span className="text-ios-gray1 text-xs">{scans.length}</span>
                              </button>
                              {unknownCount > 0 && (
                                <button onClick={() => { downloadUnknownReport(); setVendorExportTruck(null); }} className="w-full text-left px-3 py-2.5 hover:bg-ios-gray5 rounded-lg text-sm transition-colors flex items-center justify-between text-ios-orange">
                                  <span className="flex items-center gap-2">
                                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                                    </svg>
                              ...
                              <div className="border-t border-ios-gray5 my-2"></div>
                              {Object.entries(scansByVendor).filter(([vendor]) => vendor !== "Unknown").map(([vendor, vendorScans]) => (
                                <button key={vendor} onClick={() => { downloadVendorExport(vendor); setVendorExportTruck(null); }} className="w-full text-left px-3 py-2.5 hover:bg-ios-gray5 rounded-lg text-sm transition-colors flex items-center justify-between">
                                  <span>{vendor}</span>
                                  <span className="text-ios-gray1 text-xs">{vendorScans.length}</span>
                                </button>
                              ))}
                            </div>
                          </div>
              ...
              {!selectedTruck ? (
                <div className="flex flex-col items-center justify-center py-20 text-ios-gray1">
                  ...
                  <p className="text-sm text-ios-gray2">Select a truck to view scans</p>
                </div>
              ) : scans === undefined ? (
                ...
                <div className="p-5">
                  <div className="mb-4 p-4 bg-ios-orange text-white/10 border border-ios-orange/40 rounded-xl">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h3 className="font-medium text-ios-orange">Unknown Scans</h3>
                        <p className="text-sm text-ios-gray1">Scans that couldn't be matched to a vendor</p>
                      </div>
                    </div>
                  </div>
                  <div className="overflow-x-auto max-h-[400px] overflow-y-auto">
                    <table className="w-full">
                      <thead className="sticky top-0 bg-white">
                        <tr className="text-left text-ios-gray1 text-xs border-b border-ios-gray5">
                      ...
                      <tbody className="divide-y divide-ios-gray5">
                        {unknownScansAnalysis.map((scan) => (
                          <tr key={scan._id} className={`hover:bg-white transition-colors ${scan.isMiscan ? "bg-ios-red/10" : ""}`}>
                            <td className="py-3 font-mono text-ios-blue text-sm">{scan.trackingNumber}</td>
                            <td className="py-3 text-[#1c1c1e] text-sm">{scan.scannedByName || "Unknown"}</td>
                            <td className="py-3 text-ios-gray1 text-sm">{formatDate(scan.scannedAt)}</td>
                            <td className="py-3">
                              {scan.isMiscan ? (
                                <span className="inline-flex items-center px-2 py-1 rounded-lg text-xs font-medium bg-ios-red/10 text-ios-red border border-ios-red/40">
                                  Bad Scan
                                </span>
                              ) : (
                                <span className="inline-flex items-center px-2 py-1 rounded-lg text-xs font-medium bg-ios-orange/10 text-ios-orange border border-ios-orange/40">
                                  Unknown
                                </span>
                              )}
                            </td>
                            <td className="py-3">
                              ...
                              {scan.isMiscan && canEdit && (
                                <button
                                  ...
                                  className="px-3 py-1.5 bg-ios-gray5 hover:bg-ios-gray4 text-[#1c1c1e] text-xs rounded-lg transition-colors"
                                  title="Undo bad scan"
                                >
                                  Undo
                                </button>
                  ...
                  <table className="w-full">
                    ...
                    <tbody className="divide-y divide-ios-gray5">
                      {filteredScans?.map((scan) => (
                        <tr key={scan._id} className="hover:bg-white transition-colors">
                          <td className="px-5 py-3 font-mono text-xs text-ios-blue">
                            {scan.trackingNumber}
                            {(scan.quantity ?? 1) >= 2 && (
                              <span className="ml-2 inline-flex items-center px-1.5 py-0.5 rounded text-[10px] font-bold bg-ios-orange/10 text-ios-orange border border-ios-orange/40">x2</span>
                            )}
                          </td>
                          ...
                          <td className="px-5 py-3 text-[#1c1c1e] text-sm hidden sm:table-cell">{scan.destination || "-"}</td>
                          <td className="px-5 py-3 text-ios-gray1 text-sm hidden md:table-cell">{formatDate(scan.scannedAt)}</td>
                          <td className="px-5 py-3">
                            <button onClick={() => setSelectedScan(scan)} className="p-2 hover:bg-ios-gray5 rounded-lg transition-colors" title="View Details">
                              <svg className="w-4 h-4 text-ios-gray1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="bg-white border border-ios-gray5 rounded-2xl max-w-lg w-full max-h-[80vh] overflow-y-auto shadow-2xl" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="p-6 space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div><p className="text-ios-gray1 text-sm mb-1">Tracking</p><p className="font-mono text-ios-blue">{selectedScan.trackingNumber}</p></div>
                <div><p className="text-ios-gray1 text-sm mb-1">Carrier</p><p>{selectedScan.carrier || "-"}</p></div>
                <div><p className="text-ios-gray1 text-sm mb-1">Vendor</p><p className={!selectedScan.vendor || selectedScan.vendor === "Unknown" ? "text-ios-red" : "text-ios-green"}>{selectedScan.vendor || "Unknown"}</p></div>
                <div><p className="text-ios-gray1 text-sm mb-1">Account</p><p className="font-mono text-sm">{selectedScan.vendorAccount || "-"}</p></div>
                <div><p className="text-ios-gray1 text-sm mb-1">Destination</p><p>{selectedScan.destination || "-"}</p></div>
                <div><p className="text-ios-gray1 text-sm mb-1">Recipient</p><p>{selectedScan.recipientName || "-"}</p></div>
                <div><p className="text-ios-gray1 text-sm mb-1">Scanned By</p><p className="text-ios-blue">{selectedScan.scannedByName || "Unknown"}</p></div>
                <div><p className="text-ios-gray1 text-sm mb-1">Scanned At</p><p className="text-[#1c1c1e]">{selectedScan.scannedAt ? new Date(selectedScan.scannedAt).toLocaleString() : "-"}</p></div>
                <div><p className="text-ios-gray1 text-sm mb-1">Quantity</p><p className={(selectedScan.quantity ?? 1) >= 2 ? "text-ios-orange font-semibold" : "text-[#1c1c1e]"}>{(selectedScan.quantity ?? 1) >= 2 ? "Bundled Double (x2)" : "Single"}</p></div>
              </div>
              {selectedScan.address && (
                <div><p className="text-ios-gray1 text-sm mb-1">Address</p><p>{selectedScan.address}{selectedScan.city ? `, ${selectedScan.city}` : ""}{selectedScan.state ? `, ${selectedScan.state}` : ""}</p></div>
              )}
              <div>
        ...
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50 p-4" onClick={() => { setEditingAdmin(null); setEditAdminError(""); }}>
          <div className="bg-white border border-ios-gray5 rounded-2xl max-w-md w-full shadow-2xl" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="p-6 space-y-4">
              ...
              <div><label className="block text-ios-gray1 text-sm mb-2">Location Access</label><select value={editingAdmin.allowedLocations[0] || "all"} onChange={(e) => setEditingAdmin({ ...editingAdmin, allowedLocations: [e.target.value] })} className="w-full px-4 py-3 bg-white border border-ios-gray5 rounded-xl focus:outline-none focus:border-ios-blue focus:ring-2 focus:ring-ios-blue/20 transition-all"><option value="all">All Locations</option><option value="latrobe">Latrobe</option><option value="everson">Everson</option><option value="chestnut">Chestnut</option></select></div>
              <div className="flex gap-3 pt-2"><button onClick={() => { setEditingAdmin(null); setEditAdminError(""); }} className="flex-1 px-4 py-3 bg-ios-gray5 hover:bg-ios-gray4 rounded-xl font-medium transition-colors">Cancel</button><button onClick={async () => {
        ...
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50 p-4" onClick={() => setMarkingMiscan(null)}>
          <div className="bg-white border border-ios-gray5 rounded-2xl max-w-sm w-full p-6 shadow-2xl" onClick={(e) => e.stopPropagation()}>
            <div className="text-center">
              ...
              <p className="text-ios-gray1 text-sm mb-2">This will log the bad scan against the user:</p>
              <p className="text-ios-blue font-medium mb-2">{markingMiscan.scannedByName}</p>
              <p className="text-ios-gray1 text-xs font-mono mb-6">{markingMiscan.trackingNumber}</p>
              <div className="flex gap-3">
                <button onClick={() => setMarkingMiscan(null)} className="flex-1 px-4 py-3 bg-ios-gray5 hover:bg-ios-gray4 rounded-xl font-medium transition-colors">Cancel</button>
                <button
                  onClick={async () => {
